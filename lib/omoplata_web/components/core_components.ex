defmodule OmoplataWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OmoplataWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OmoplataWeb.Gettext, "errors", msg, opts)
    end
  end
